...
<button value="book"><a href="reservations/current">Existing Bookings</a></button><br>
...
<button value="past"><a href="reservations/past">Past Reservations and Orders</a></button><br>
<button value="report"><a href="reports">View Reports</a></button><br>
</div>
</c:if>
